                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        <form method="post" action="">
                                <select name="cinemalist" class="form-control" onchange="javascript:location.href=this.value;">
                                    <option>請選擇影城</option>
                                        <optgroup label="雙北">
                                            <option value="ShowAllMovie.php" selected="selected"><?php echo $row1['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row2['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row3['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row4['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row5['studio_name']; ?></option>
                                        </optgroup>
                                        <optgroup label="桃竹苗">
                                            <option value="ShowAllMovie.php"><?php echo $row6['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row9['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row8['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row7['studio_name']; ?></option>
                                        </optgroup>
                                        <optgroup label="中、東部">
                                            <option value="ShowAllMovie.php"><?php echo $row10['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row12['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row11['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row17['studio_name']; ?></option>
                                        </optgroup>
                                        <optgroup label="南部">
                                            <option value="ShowAllMovie.php"><?php echo $row13['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row14['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row15['studio_name']; ?></option>
                                            <option value="ShowAllMovie.php"><?php echo $row16['studio_name']; ?></option>
                                        </optgroup>
                                </select>
                            </form>
                        </li>
