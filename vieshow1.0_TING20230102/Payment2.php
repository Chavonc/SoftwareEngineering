...
<body>
     ...
     $totalmoney = $_SESSION['totalmoney'];
     if ($rs[3] < $totalmoney) {
          show_msg("儲值金不足，請先儲值", '', 'http://localhost/vieshow1.0/StoredValue.php');
     }
     ?>
     <div>
          <input type="button" value="取消付款" class="btn btn-light" style="position:absolute; top:620px;right:60%;background-color:red;color:white;font-weight:bold;" onclick="location.href='Home.php'">
     </div>
</body>
