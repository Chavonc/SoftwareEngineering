...
<body>
    ...
    <div>
        <table style="position:absolute; top:150px;right:5%;width:260px;border: 1px solid black;">
            ...
            <tr style="background-color:#D6FFFF;color:black">
                <td>
                    <center><img src="anya01.png" width="50px"></center>
                </td>
                <td>
                    <?php
