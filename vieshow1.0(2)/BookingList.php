...
<!-- <script language="Javascript">
    var getData=localStorage.getItem('myName');
    //console.log(getData);
    var resultSeat=getData.split(",").map((item)=>item.trim());
    // console.log(resultSeat);
    // console.log(resultSeat[0]);
    // console.log(resultSeat[1]);
</script> -->
<body>
    <div class="row">
     ...
     <div>
          ...
          <table style="position:absolute;top:240px;left:5%;width:600px;">
              ...
              <tr style="background-color:#D6FFFF;color:black;">
                ...
                <td colspan="5">
                    <!-- <script>
                    document.write("&ensp;&ensp;" + getData);
                </script> -->
                    <?php
                    $resultSeat = explode(",", $seatlist);
                    //輸出資料
                    // echo $resultSeat[1]; //de
                    echo $seatlist;
