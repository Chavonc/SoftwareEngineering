...
<body>
    <div class="row">
        <nav class="navbar navbar-expand-sm bg-primary navbar-dark" id="DeepBlueBar" width="100%">
            <font size="2px">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link" href="hometest.php">VIESHOW</a></li>
                    <li class="nav-item"><a class="nav-link" href="Login.phph">會員登入</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="MemberService.php">會員服務</a></li>
                    <li class="nav-item"><a class="nav-link" href="Explaination.php">操作說明</a></li>
                </ul>
            </font>
        </nav>
    ...
    <div>
        ...
        <img src="MoviePicture/1.png" width="150" style="position:absolute;top:180px;left:10%;">
        <table>
            <tr>
        ...
        <div id="Date1" style="position:absolute;top:230px;left:47%;display:none;">
            <ol>
                <ul>
                    <li><!------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------>
                        <a href="BookingTicket.php?&studio_id<?php echo $show_cinema?>MOVIEid=<?php echo $show_id?>&MOVIEDATE=2023/01/06&MOVIETIME=<?php echo $row_time11['screening_time']?>&MOVIEGRADING=<?php echo $row_2['grading_name']?>" style="text-decoration:blink;"><?php echo $row_time11['screening_time']; ?></a>
                        &nbsp;&nbsp;&nbsp;
                    ...
                    <br>
                    <li>
                        <a href="BookingTicket.php?&studio_id<?php echo $show_cinema?>MOVIEid=<?php echo $show_id?>&MOVIEDATE=2023/01/06&MOVIETIME=<?php echo $row_time12['screening_time']?>&MOVIEGRADING=<?php echo $row_2['grading_name']?>" style="text-decoration:blink;"><?php echo $row_time12['screening_time']; ?></a>
                        &nbsp;&nbsp;&nbsp;
        ...
        <div id="Date2" style="position:absolute;top:230px;left:47%;display:none;">
            <ol>
                <ul>
                    <li>
                        <a href="BookingTicket.php?&studio_id<?php echo $show_cinema?>MOVIEid=<?php echo $show_id?>&MOVIEDATE=2023/01/07&MOVIETIME=<?php echo $row_time21['screening_time']?>&MOVIEGRADING=<?php echo $row_2['grading_name']?>" style="text-decoration:blink;"><?php echo $row_time21['screening_time']; ?></a>
                        &nbsp;&nbsp;&nbsp;
                    ...
                    <br>
                    <li>
                        <a href="BookingTicket.php?&studio_id<?php echo $show_cinema?>MOVIEid=<?php echo $show_id?>&MOVIEDATE=2023/01/07&MOVIETIME=<?php echo $row_time22['screening_time']?>&MOVIEGRADING=<?php echo $row_2['grading_name']?>" style="text-decoration:blink;"><?php echo $row_time22['screening_time']; ?></a>
                        &nbsp;&nbsp;&nbsp;
        ...
        <div id="Date3" style="position:absolute;top:230px;left:47%;display:none;">
            <ol>
                <ul>
                    <li>
                        <a href="BookingTicket.php?&studio_id<?php echo $show_cinema?>MOVIEid=<?php echo $show_id?>&MOVIEDATE=2023/01/08&MOVIETIME=<?php echo $row_time31['screening_time']?>&MOVIEGRADING=<?php echo $row_2['grading_name']?>" style="text-decoration:blink;"><?php echo $row_time31['screening_time']; ?></a>
                        &nbsp;&nbsp;&nbsp;
                    ...
                    <br>
                    <li>
                        <a href="BookingTicket.php?&studio_id<?php echo $show_cinema?>MOVIEid=<?php echo $show_id?>&MOVIEDATE=2023/01/08&MOVIETIME=<?php echo $row_time32['screening_time']?>&MOVIEGRADING=<?php echo $row_2['grading_name']?>" style="text-decoration:blink;"><?php echo $row_time32['screening_time']; ?></a>
                        &nbsp;&nbsp;&nbsp;
