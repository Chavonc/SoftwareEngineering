...
<body>
    ...
    <div>
     ...
     <div>
          <table style="position:absolute;top:220px;left:5%;width:240px;">
              <tr style="background-color:steelblue;color:white">
                  <th><center>確認購物清單</center></th>
              </tr>
              <tr style="background-color:#D6FFFF;color:black">
                  <td>
     ...
     <div>
          <input type="button" name="Submit" value="儲值金付款" class="btn btn-light" style="position:absolute;top:300px;left:35%;" onclick="location.href='Payment.php?STUDIOid=<?php echo $show_cinema?>&MOVIEid=<?php echo $show_id?>&MOVIEDATE=<?php echo $show_date?>&MOVIEGRADING=<?php echo $show_grading?>&MOVIETIME=<?php echo $show_time?>&MOVIEIWANT_id=<?php echo $row_movie_I_want_id['movie_I_want_id']?>'">
     </div>
</body>
</html>